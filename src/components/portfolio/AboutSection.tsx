...
export default function AboutSection() {
  return (
    ...
    >
      <h2 className="text-3xl font-headline font-bold mb-4 text-left md:text-center"><User className="inline-block mr-2 h-7 w-7 text-primary" /> About Me</h2>
      <p className="text-lg text-muted-foreground text-left md:text-justify max-w-3xl mx-auto">
