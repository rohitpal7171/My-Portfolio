  ...
  return (
    <div className="bg-background text-foreground font-body min-h-screen">
      ...
      <main className="container mx-auto px-4 pt-32 pb-16">
        ...
        {/* Hero Section */}
        <section id="hero" className="grid md:grid-cols-2 items-center gap-12 mb-24">
          ...
          <div className="flex-shrink-0 flex flex-col items-center justify-center p-4 bg-secondary/30 rounded-lg border border-primary/20">
            ...
            />
            <Card className="w-full mt-4 bg-transparent border-primary/30">
              <CardHeader>
        ...
        {/* About Section */}
        <section id="about" className="mb-24 p-8 border border-primary/20 rounded-lg bg-secondary/20">
        ...
        <section id="skills" className="mb-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {Object.entries(skills).map(([category, skillList]) => (
              <Card key={category} className="bg-secondary/30 border-primary/20 hover:border-primary/50 transition-all">
                <CardHeader>
